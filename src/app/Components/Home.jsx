    ...
    <>
      ...
      <div className='home'>
        ...
        <div className='right'>
          ...
          <p className='para'>Greetings! I'm Dhairya Gupta, a proficient full-stack developer passionate about transforming ideas into cutting-edge web applications. Dive into my portfolio to explore my latest projects, where I showcase my expertise in React.js, Next.js, and various facets of web development. Let's innovate and build something extraordinary together!</p>
